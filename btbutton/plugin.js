                ...
                editor.widgets.add('btbutton', {
                    ...
                    data: function () {
                        ...
                        if (this.data.btntype) {
                            $el.removeClass('btn-link btn-default btn-light btn-primary btn-info btn-success btn-warning btn-danger btn-outline-light btn-outline-primary btn-outline-success btn-outline-info btn-outline-warning btn-outline-danger').addClass(this.data.btntype);
                        }
